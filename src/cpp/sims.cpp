...
double **alloc_model(int n_nodes) {
  ...
  // L [n]
  model_ptrs[5] = model_data + n_nodes * n_nodes * 4 + n_nodes * 1;
  // B [n]
  model_ptrs[6] = model_data + n_nodes * n_nodes * 4 + n_nodes * 2;
  // Y [n]
  model_ptrs[7] = model_data + n_nodes * n_nodes * 4 + n_nodes * 3;
  // P [n]
  model_ptrs[8] = model_data + n_nodes * n_nodes * 4 + n_nodes * 4;
  // Pi [n]
  model_ptrs[9] = model_data + n_nodes * n_nodes * 4 + n_nodes * 5;
